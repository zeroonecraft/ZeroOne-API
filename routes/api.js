...
router.get('/textpro/glitch2', async (req, res, next) => {
	...
	if (!text1 ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter text 1"})   
	if (!text2 ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter text 2"}) 
...
router.get('/soundoftext', async (req, res, next) => {
	...
	if (!text1 ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter text"})   
	if (!lan ) return res.json({ status : false, creator : `${creator}`, message : "[!] Silahkan masukan language code dengan benar, https://soundoftext.com/docs#voices untuk lihat list language code"})   
...
router.get('/randomgambar/couplepp', async (req, res, next) => {
	...
	let resultt = await fetchJson('https://raw.githubusercontent.com/zeroonecraft/data-api/main/data/gambar/json/kopel.json')
...
router.get('/randomgambar/dadu', async (req, res, next) => {
	...
	let dadu = await fetchJson('https://raw.githubusercontent.com/zeroonecraft/data-api/main/data/gambar/json/dadu.json')
...
router.get('/randomgambar/cyberspace', async (req, res, next) => {
	...
	let cyberspace = await fetchJson('https://raw.githubusercontent.com/zeroonecraft/data-api/main/data/gambar/json/cyberspace.json')
...
router.get('/randomgambar/game', async (req, res, next) => {

	let resultt = await fetchJson('https://raw.githubusercontent.com/zeroonecraft/data-api/main/data/gambar/json/game.json')
	let random = resultt[Math.floor(Math.random() * resultt.length)]
...
router.get('/randomgambar/islamic', async (req, res, next) => {

	let resultt = await fetchJson('https://raw.githubusercontent.com/zeroonecraft/data-api/main/data/gambar/json/islamic.json')
	let random = resultt[Math.floor(Math.random() * resultt.length)]
...
router.get('/randomgambar/mountain', async (req, res, next) => {

	let resultt = await fetchJson('https://raw.githubusercontent.com/zeroonecraft/data-api/main/data/gambar/json/mountain.json')
	let random = resultt[Math.floor(Math.random() * resultt.length)]
...
router.get('/randomgambar/programming', async (req, res, next) => {
	...
	let resultt = await fetchJson('https://raw.githubusercontent.com/zeroonecraft/data-api/main/data/gambar/json/programming.json')
	let random = resultt[Math.floor(Math.random() * resultt.length)]
...
router.get('/randomgambar/technology', async (req, res, next) => {

	let resultt = await fetchJson('https://raw.githubusercontent.com/zeroonecraft/data-api/main/data/gambar/json/technology.json')
	let random = resultt[Math.floor(Math.random() * resultt.length)]
...
router.get('/game/tebakbendera', async (req, res, next) => {
	...
	let ra = await fetchJson('https://raw.githubusercontent.com/zeroonecraft/data-api/main/data/game/data/game/tebakbendera.json')
...
router.get('/game/tebaktebakan', async (req, res, next) => {
	...
	let ra = await fetchJson('https://raw.githubusercontent.com/zeroonecraft/data-api/main/data/game/tebaktebakan.json')
	let ha = ra[Math.floor(Math.random() * ra.length)]
...
router.get('/game/tebakjenaka', async (req, res, next) => {
	...
	let ra = await fetchJson('https://raw.githubusercontent.com/zeroonecraft/data-api/main/data/game/tebakjenaka.json')
	let ha = ra[Math.floor(Math.random() * ra.length)]
...
router.get('/game/tebakgame', async (req, res, next) => {
	...
	let ra = await fetchJson('https://raw.githubusercontent.com/zeroonecraft/data-api/main/data/game/tebakgame.json')
	let ha = ra[Math.floor(Math.random() * ra.length)]
...
router.get('/game/tebakkata', async (req, res, next) => {
	...
	let ra = await fetchJson('https://raw.githubusercontent.com/zeroonecraft/data-api/main/data/game/tebakkata.json')
	let ha = ra[Math.floor(Math.random() * ra.length)]
...
router.get('/game/tebaklirik', async (req, res, next) => {
	...
	let ra = await fetchJson('https://raw.githubusercontent.com/zeroonecraft/data-api/main/data/game/tebaklirik.json')
	let ha = ra[Math.floor(Math.random() * ra.length)]
...
router.get('/game/tebaklagu', async (req, res, next) => {
	...
	let ra = await fetchJson('https://raw.githubusercontent.com/zeroonecraft/data-api/main/data/game/tebaklagu.json')
	let ha = ra[Math.floor(Math.random() * ra.length)]
...
router.get('/game/tebakkimia', async (req, res, next) => {
	...
	let ra = await fetchJson('https://raw.githubusercontent.com/zeroonecraft/data-api/main/data/game/tebakkimia.json')
	let ha = ra[Math.floor(Math.random() * ra.length)]
...
router.get('/game/susunkata', async (req, res, next) => {
	...
	let ra = await fetchJson('https://raw.githubusercontent.com/zeroonecraft/data-api/main/data/game/susunkata.json')
	let ha = ra[Math.floor(Math.random() * ra.length)]
...
router.get('/game/caklontong', async (req, res, next) => {
	...
	let ra = await fetchJson('https://raw.githubusercontent.com/zeroonecraft/data-api/main/data/game/caklontong.json')
	let ha = ra[Math.floor(Math.random() * ra.length)]
...
router.get('/maker/darkness', async (req, res) => {
	...
	var no = req.query.no
	if (!text ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter url"})
	if (!no ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter angka/nomor"})

	var img = await isImageURL(text)
	var n = isNumber(no)
	if ( !img ) return res.json({ status : false, creator : `${creator}`, message : "[!] cek kembali url image"}) 
	if ( !n ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan angka/nomor bukan text"}) 
...
router.get('/maker/resize', async (req, res) => {
	...
	if (!text ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter url"})
	if (!width ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter width (lebar) dengan angka/nomor"})
	if (!height ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter height (tinggi) dengan angka/nomor"})
	...
	if ( !img ) return res.json({ status : false, creator : `${creator}`, message : "[!] cek kembali url image"}) 
	if ( !wid ) return res.json({ status : false, creator : `${creator}`, message : "[!] parameter width (lebar) diisi hanya angka/nomor bukan text"}) 
	if ( !hei ) return res.json({ status : false, creator : `${creator}`, message : "[!] parameter height (tinggi) diisi hanya angka/nomor bukan text"}) 
...
router.get('/maker/emojimix', async (req, res, next) => {
	...
	if (!emoji1 ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter emoji 1"})
	if (!emoji2 ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter emoji 2"})  
...
router.get('/maker/welcome1', async (req, res, next) => {
	...
	if (!grup ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter group name"})  
    if (!member ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter member"})  
	if (!pp ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter Photo Profile"})  
    if (!bg ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter Background"})  

	if ( !imgpp ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukkan url image Photo Profile dengan benar"}) 
	if ( !bgimg ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukkan url image Background dengan benar"}) 
...
router.get('/linkshort/tinyurl', async (req, res, next) => {
	...
	if (!link ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter url"})  
...
router.get('/info/githubstalk', async (req, res, next) => {
	...
	if (!user ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter nama user"})  
...
router.get('/info/translate', async (req, res, next) => {
	...
	if (!text ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter text"})  
	if (!lang ) return res.json({ status : false, creator : `${creator}`, message : "[!] Silahkan masukan language code dengan benar, https://cloud.google.com/translate/docs/languages untuk lihat list language code"})  
...
router.get('/islamic/surah', async (req, res, next) => {
	...
	if (!text1 ) return res.json({ status : false, creator : `${creator}`, message : "[!] masukan parameter nomor surat"})  
	alip.surah(text1)
.then((data) =>{ 
	if (!data ) return res.json(loghandler.notfound)
		res.json({
